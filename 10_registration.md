...
1. You can download the evaluation data from the [Mozilla Data Collective](https://datacollective.mozillafoundation.org/datasets/cmkv32i5e02tumg07j79d3c35). The easiest way to download the files is described on the [Dataset Download](https://tidyvoice2026.github.io/2_dataset_download/) page.

2. The trial pairs files can be downloaded [here](https://drive.google.com/file/d/1tIFjYnRHGLypciX4Dl7IBX86vymAnVRP/view?usp=sharing). There are two trial pair files:
